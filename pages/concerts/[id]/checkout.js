                                        ...
                                        <>
                                            <div>
                                                ...
                                                <div className="mt-2 text-center ">
                                                    ...
                                                    <p className="mt-2">
                                                        <span
                                                            className=" font-bold">Ticket Price</span> : {concertData.price}
                                                    </p>
                                                    <p className="mt-2">
                                                        <span
                                                            className=" font-bold">Available Seats Remaining</span> : {concertData.availableSeats}
                                                    </p>
                                                    <p className="mt-8">
                                                    ...
                                                    <p>
                                                        <span
                                                            className="text-3xl font-bold">{concertData.price * ticketsNumber}</span> €
                                                    </p>
                                                    <button
                                        ...
                                        <>
                                            <div className="grid grid-cols-2 gap-2">
                                                ...
                                                <div className="mt-2 ">
                                                    <p className="mt-4">
                                                        <span
                                                            className="text-lg font-bold">Title</span> : {concertData.title}
                                                    </p>
                                                    <p className="mt-4">
                                                        <span
                                                            className="text-lg font-bold">Place</span> : {concertData.place}
                                                    </p>
                                                    <p className="mt-4">
                                                        <span
                                                            className="text-lg font-bold">Ticket Price</span> : {concertData.price}
                                                    </p>
                                                    <p className="mt-4">
                                                        <span
                                                    ...
                                                    {user?.email ? (
                                                        <button
                                                            className="mt-[160px] ml-[48px] bg-[#ffba5a] text-white w-[140px] h-[50px] rounded-full shadow-md scale-100 hover:scale-105 ease-in duration-100 ">
                                                            Book A Ticket
                                                        </button>
                                                    ) : (
                                                        <button
                                                            className="mt-6 ml-[48px] bg-[#f7d5a6] text-white w-[140px] h-[50px] rounded-full shadow-md scale-100 hover:scale-105 ease-in duration-100 cursor-not-allowed">
                                                            Book A Ticket
                                                        </button>
                                                    )}
                                                </div>
